...
namespace DotNetCoreGraphQl.Migrations
{
    ...
    [Migration("20230806103158_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetCoreGraphQl.Model.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c311722-f99e-42f1-a87b-db835ea1fb39"),
                            ...
                            SuperheroId = new Guid("5ed0d038-3525-4c7a-b243-fa7c5f5a2aa9"),
                            Title = "Batman Begins"
                        },
                        new
                        {
                            Id = new Guid("cd7c3f63-98a2-427e-9e5f-fb3fa12f4c96"),
                        ...
                        new
                        {
                            Id = new Guid("8842e0bf-4763-4004-82ca-d0f0d9de532d"),
                        ...
                        new
                        {
                            Id = new Guid("5dcaa83a-e4c9-4d7b-a9ac-2f871af552ec"),
                            ...
                            SuperheroId = new Guid("77f12ed9-2087-4b87-bfcf-b87d91b34c12"),
                            Title = "Star Wars: Episode IV – A New Hope"
                        },
                        new
                        {
                            Id = new Guid("29140fdd-b0c6-4d37-b1dd-9847fd945fe3"),
                        ...
                        new
                        {
                            Id = new Guid("25287ab9-8f4b-4b96-8afa-3707188c9514"),
                        ...
                        new
                        {
                            Id = new Guid("caa82aa4-ff20-4485-843d-29432ac91268"),
                            ...
                            SuperheroId = new Guid("27e0f5ce-4e45-4854-84ff-2d0e42dfcf60"),
                            Title = "Black Widow"
                        });
                });

            modelBuilder.Entity("DotNetCoreGraphQl.Model.Superhero", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5ed0d038-3525-4c7a-b243-fa7c5f5a2aa9"),
                        ...
                        new
                        {
                            Id = new Guid("77f12ed9-2087-4b87-bfcf-b87d91b34c12"),
                        ...
                        new
                        {
                            Id = new Guid("27e0f5ce-4e45-4854-84ff-2d0e42dfcf60"),
            ...
            modelBuilder.Entity("DotNetCoreGraphQl.Model.Superpower", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4630307b-96a5-4a83-8d0d-c5cfa74b4afc"),
                        ...
                        new
                        {
                            Id = new Guid("02c409c0-6e5f-4975-91ef-150cfedc90dd"),
                        ...
                        new
                        {
                            Id = new Guid("23dae16f-80ed-465e-be38-c74adeb7a5af"),
                        ...
                        new
                        {
                            Id = new Guid("0389393e-cbf7-4ed3-864f-c71af2a6b6b2"),
                        ...
                        new
                        {
                            Id = new Guid("c5668721-727a-42b3-ae4a-0fdf4bbf43e9"),
                        ...
                        new
                        {
                            Id = new Guid("fd0664c4-a3c4-4d2c-9111-11e0d4dcbf86"),
                        ...
                        new
                        {
                            Id = new Guid("275f1bba-32b4-4723-a5d1-d06af0bbbb07"),
            ...
            modelBuilder.Entity("DotNetCoreGraphQl.Model.Movie", b =>
                {
                    b.HasOne("DotNetCoreGraphQl.Model.Superhero", "Superhero")
                        .WithMany("Movies")
